source "amazon-ebs" "rhel9_cis_1" {
  ...
  # AMI CONFIG
  ami_name        = "RHEL9-CIS-1-${local.timestamp}"
  ami_description = "RHEL9 default image with quartely patching. Built with Packer."
...
build {
  ...
  provisioner "ansible" {
    playbook_file = var.rhel9_playbook
  }
